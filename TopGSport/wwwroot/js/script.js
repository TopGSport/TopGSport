document.addEventListener("DOMContentLoaded", function () {
    ...
    const translations = {
        pl: {
            ...
            testimonial1: "Fajny klub. To był wypadek drogowy, a klub zrobił на mnie bardzo pozytywne wrażenie. Pani w recepcji jest bardzo kompetentna i pomocna. Sprzęt jest rozsądnie rozmieszczony.",
    ...
    import("https://cdn.voiceflow.com/widget/bundle.mjs").then(() => {
        window.voiceflow.chat.load({
            verify: { projectID: "67aa67cf361d73c432e56f4a" },
